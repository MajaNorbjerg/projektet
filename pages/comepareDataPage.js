    ...
    template() {
        ...
        document.querySelector('#pagesSection').innerHTML += /*html*/ `
            ...
            <a id="lande">Lande</a>
                ...
                <g/>
                /* ------------st1 sjælland----------- */
                    <g onclick="mapToChart(this, 'zeaDenmark', 'ZpCPJdBCL6aurufSlCCY', '#3cc4eb')" onmouseover="border(this, 'zeaDenmark')" onmouseout="ikkeBorder(this, 'zeaDenmark')">
                ...
                /* ------------st2 Syddanmark----------- */
                            <g onclick="mapToChart(this, 'southDenmark', 'CwsGcarffzaNsTnUe6ZV', '#f8353c')" onmouseover="border(this, 'southDenmark')" onmouseout="ikkeBorder(this, 'southDenmark')">
           ...
           2.1,284.5,124.7,286.2z"/>
                 ...
                 /* ------------st3 - norddanmark----------- */
                        <g id="northMap" onclick="mapToChart(this, 'northDenmark', '7OIHxbSLJcSF2sXVtxTA', '#7d5d8a')" onload="mapToChart(this, 'northDenmark', '7OIHxbSLJcSF2sXVtxTA', '#7d5d8a')" onmouseover="border(this, 'northDenmark')" onmouseout="ikkeBorder(this, 'northDenmark')" >
